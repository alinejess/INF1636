...
class Tabuleiro {
    ...
    static Tabuleiro criarPadrao() {
        ...
        s.add(new CasaEspecial("Metrô", CasaEspecial.Tipo.METRO));                       // 5
        s.add(Propriedade.criarBasica("Av. Brigadero Faria Lima", 240));                    // 6
        s.add(new CasaEspecial("Ônibus", CasaEspecial.Tipo.ONIBUS));                     // 7
        ...
        s.add(new CasaEspecial("Táxi", CasaEspecial.Tipo.TAXI));                         // 15
        ...
        s.add(new CasaEspecial("Barca", CasaEspecial.Tipo.BARCA));                       // 25
        ...
        s.add(new CasaEspecial("Avião", CasaEspecial.Tipo.AVIAO));                       // 32
        s.add(Propriedade.criarBasica("Av. Vieira Souto", 320));                         // 33
        s.add(Propriedade.criarBasica("Av. Atlântica", 300));                            // 34
        s.add(new CasaEspecial("Helicoptero", CasaEspecial.Tipo.HELICOPTERO));           // 35
