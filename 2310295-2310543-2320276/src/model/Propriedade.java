...
public class Propriedade extends Casa {
    ...
    // ==== GETTERS que a UI espera ====
    /** Quantidade de casas construídas (0..4). */
    public int getCasas() {
        return casas;
    }

    /** Indica se há hotel construído nesta propriedade. */
    public boolean isHotel() {
        return hotel;
    }

    /** (Opcional) Útil para o Controller/UI saber se pode tentar construir nesta jogada. */
    public boolean isPodeConstruirNestaJogada() {
        return podeConstruirNestaJogada;
    }
    // =================================
